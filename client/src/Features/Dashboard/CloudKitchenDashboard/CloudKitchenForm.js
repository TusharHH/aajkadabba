                    ...
                    <div className="row justify-content-center">
                        ...
                        <div className="col-md-4 col-sm border p-3 shadow-lg bg-white mb-5  d-flex flex-column" style={{ height: '100vh', objectFit: 'cover' }}>
                            ...
                            <div className='d-flex w-100 justify-content-center'>
                                <p className='fw-bold' style={{ fontSize: "35px" }}>Create Cloud Kitchen</p>
                            </div>
                                ...
                                <>
                                    ...
                                    <div className="row-md-4 mt-1">
                                        ...
                                        <input
                                            ...
                                            required
                                        />
                                        {errors.name && <div className="invalid-feedback">Description is required</div>}
                                    </div>
                                    <div className='mt-5'>
...
export default CloundKitchenForm;
