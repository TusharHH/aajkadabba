                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0 " style={{ gap: '20px' }}>
                            <li className="nav-item">
                                <Link className="nav-link active fs-6" aria-current="page" to="/"><i className="bi bi-house" style={{ marginRight: '5px' }}></i>Home</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link fs-6" to="/aboutUs"><i className="bi bi-info-circle" style={{ marginRight: '5px' }}></i>About Us</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link fs-6" to="/contactUs"><i className="bi bi-grid" style={{ marginRight: '5px' }}></i>Contact Us</Link>
                            </li>
                        </ul>
