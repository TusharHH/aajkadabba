                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0" style={{ gap: '20px' }}>
                            ...
                            <li className="nav-item">
                                <Link className="nav-link fs-6" to="/about"><i className="bi bi-info-circle" style={{ marginRight: '5px' }}></i>About Us</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link fs-6" to="/features"><i className="bi bi-grid" style={{ marginRight: '5px' }}></i>Contact Us</Link>
                            </li>
                        </ul>
